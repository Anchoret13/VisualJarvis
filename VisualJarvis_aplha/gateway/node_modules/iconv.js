...
module.exports = {
  encodeGBK : function(str) {
	    ...
	    for (var i = 0; i < strlen; i++) {
	        ...
	        if(unicode>256){//汉字
	            var gbkcode=g_uft2gbk[unicode];
	            u8.push(Math.floor(gbkcode/256));
	            u8.push(gbkcode%256);
	        }else{
	            u8.push(unicode);
	        }
